...
ALTER TABLE DELIVERY ADD CONSTRAINT D_CODE_FK FOREIGN KEY(CODE) REFERENCES DELI_CUSTOMER(CODE) 
ON DELETE CASCADE; 

ALTER TABLE DELIVERY ADD CONSTRAINT D_CODE_PK PRIMARY KEY(CODE);-- 식별관계??

ALTER TABLE DELIVERY ADD CONSTRAINT D_NAME_FOOD_PRICE_FK FOREIGN KEY(NAME,FOOD,PRICE) 
REFERENCES RESTAURANT(NAME,FOOD,PRICE) ON DELETE CASCADE;-- 비식별관계??
